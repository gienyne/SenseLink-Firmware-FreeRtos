  ...
  return (
    <div className="chart-card">
      <div className="chart-hdr">
        <span className="chart-title">Temperature &amp; humidity - last {MAX_HISTORY} readings</span>
      ...
      {history.length < 2 ? (
        ...
        <ResponsiveContainer width="100%" height={200}>
          <AreaChart data={history} margin={{ top: 6, right: 4, left: -18, bottom: 0 }}>
            ...
            <XAxis dataKey="time" tick={{ fontSize: 10, fill: '#9a8f80' }} tickLine={false} axisLine={false} interval="preserveStartEnd" />
            <YAxis tick={{ fontSize: 10, fill: '#9a8f80' }} tickLine={false} axisLine={false} />
